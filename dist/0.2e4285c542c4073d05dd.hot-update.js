...
let ProductController = class ProductController {
    ...
    async createProduct(file, productData) {
        try {
            productData.logo_product = file ? `/uploads/${file.filename}` : null;
            const newProduct = await this.productService.save(productData);
            return new globalClass_1.ResponseData(newProduct, 200, 'Product created successfully');
        }
        catch (error) {
            return new globalClass_1.ResponseData(null, 500, 'Error creating product');
        }
    }
    async getAllProduct() {
        try {
...
__decorate([
    ...
    __param(1, (0, common_1.Body)()),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [Number, typeof (_f = typeof product_entity_1.ProductEntity !== "undefined" && product_entity_1.ProductEntity) === "function" ? _f : Object]),
...
/******/ (() => {
/******/ 	__webpack_require__.h = () => ("b0ae92ad1e8002ecebb1")
/******/ })();
/******/ 
/******/ }
;